...
<section class="myclasssec">
      ...
      <div id="collapseOne" class="accordion-collapse collapse" aria-labelledby="CSE3013" data-bs-parent="#accordionExample">
       ...
       <div class="container">
         ...
         <p class="m-0 p-0">CAT 1</p>
             ...
             <a href="#" class="btn shadow-none"> <span  class="time-f">
                 ...
                 <a href="#" class="btn rounded-0 btn shadow-none btn-completed" >Completed</a>
            </div>
           </div>
      ...
      <p class="m-0 p-0">CAT 2</p>
            ...
            <div class="col-8 text-center">
             <p class="m-0 p-0">22nd Dec 2020
              ...
              <a href="#" class="btn rounded-0 btn shadow-none btn-join-exam" >Join Exam</a>
         </div>
        </div>
      ...
      <p class="m-0 p-0">LAB FAT</p>
            ...
            <div class="col-8 text-center">
             <p class="m-0 p-0">22nd Dec 2020
              ...
              <div class="col-2  text-white text-end">
              <a href="#" class="btn rounded-0 btn shadow-none btn-join-exam btn-completed" >Yet to start</a>
         </div>
        </div>
      ...
      <p class="m-0 p-0">CAT 2</p>
            ...
            <div class="col-8 text-center">
             <p class="m-0 p-0">22nd Dec 2020
              ...
              <div class="col-2  text-white text-end">
              <a href="check" class="btn rounded-0 btn shadow-none btn-join-exam" >Join Exam</a>
         </div>
        </div>
  ...
  <div class="row bottom-text w-100 m-0 p-0 max-auto text-white px-5">
    <div class="col text-left ps-5 ms-3"> <a href="home"> <p class="text-white"><u>Take Demo Exam</u></p></a></div>
    <div class="col">
       <a href="settings" class=""> <p class="pro-end">
        <span class="name">Samuel Doe</span>
        <br/>
        <span class="span-n"> 18BIS1241</span>
        <img src="1.png" class="img-p" alt="" srcset=""/>
    </p>
</a>
</div>
</div>
